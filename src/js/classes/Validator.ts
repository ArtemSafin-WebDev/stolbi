...
class Validator {
  ...
  private showTextFieldMessage(
    ...
    const errorContainerSelector = field.getAttribute("data-error-container");
    const parent = errorContainerSelector
      ? document.querySelector<HTMLElement>(errorContainerSelector)
